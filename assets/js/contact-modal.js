/* ============================================================
   ...
   opens a WhatsApp / Instagram / Email channel-selector modal.
...
(function () {
  ...
  const T = {
    ...
    emName    : isAR ? 'البريد الإلكتروني'                 : 'Email',
    emHint    : isAR ? 'راسلنا على ' + EMAIL                : 'Write to us at ' + EMAIL,
  ...
  /* ── EMAIL SVG ───────────────────────────────────────── */
  const EM_SVG = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  <div class="cm-backdrop" id="cm-backdrop" role="dialog" aria-modal="true" aria-label="${T.eyebrow}">
    <div class="cm-card" id="cm-card">
      ...
      <div class="cm-channels">
        ...
        <a href="${EMAIL_URL}" target="_blank" rel="noopener noreferrer" class="cm-channel cm-channel--em">
          <div class="cm-channel-icon">${EM_SVG}</div>
          <div class="cm-channel-text">
            <span class="cm-channel-name">${T.emName}</span>
            <span class="cm-channel-hint">${T.emHint}</span>
          </div>
          <div class="cm-channel-arrow">${ARROW_SVG}</div>
        </a>
